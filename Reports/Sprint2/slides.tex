...
\begin{frame}{Basic Monster Agents}
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \textbf{Behavior: Finite State Machine (FSM)}
            \begin{itemize}
...
\begin{frame}{The Twist (Spoilers!)}
    \begin{alertblock}{The Secret}
        Sir Cael \textbf{is} the Chronicler.
    \end{alertblock}
    \begin{itemize}
        \item He was a scholar who, in an attempt to preserve a "perfect" version of his falling kingdom's history, trapped reality inside the book and split himself in two.
        \item The bosses he fights are manifestations of his own guilt (Sentinel) and denial (Herald).
        \item \textbf{The True Ending:} The final battle is a confrontation with himself. To truly win and end the cycle, the player must choose to "Lower your sword" instead of striking the final blow, thereby accepting an imperfect story and ending the rewrites.
    \end{itemize}
\end{frame}
