...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.32\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/ca_screenshots/forest_theme.png}
        \caption*{Forest Theme}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.32\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/ca_screenshots/night_theme.png}
        \caption*{Night Theme}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.32\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/ca_screenshots/hell_theme.png}
        \caption*{Hell Theme}
    \end{minipage}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{figures/ca_screenshots/lake_example.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{figures/ca_screenshots/paths_example.png}
